...
with st.form("dnf_form"):
    grid = st.number_input("Grid Position", min_value=1, max_value=34, step=1)
    year = st.number_input("Year", min_value=1950, max_value=2025, step=1)
    ...
    circuit_id = st.number_input("Circuit ID", min_value=1, max_value=80, step=1)
